const factsData = {
  ...
  capital: {
    ...
    shortText: "Tokyo",
    details:
      "Tokyo, formerly known as Edo, became Japan's capital in 1868 during the Meiji Restoration when Emperor Meiji moved the imperial court from Kyoto. Today, Tokyo stands as the world's most populous metropolitan area with over 37 million residents in its greater metro region. The city is divided into 23 special wards, 26 cities, 5 towns and 8 villages, forming a complex administrative structure that operates as both a city and a prefecture. As a global financial center and cultural hub, Tokyo seamlessly blends ultramodern skyscrapers and cutting-edge technology with historic temples and traditional neighborhoods. The city has hosted the Summer Olympics twice, first in 1964 and again in 2020 (held in 2021 due to the pandemic), showcasing its role as a world-class city that honors both innovation and tradition.",
  },
  region: {
    icon: "🌏",
    title: "Region",
